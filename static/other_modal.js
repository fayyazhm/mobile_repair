const other_modal = Vue.component("other_modal", {
    template: `
    <div>
    ...
    <b-modal v-model="showModal"  hide-footer @hide="onModalClose" title="Other Repair Details" title-class="mx-auto">
    <form>
  ...
  data(){
    return{
        user_name:"",email:"",mobile:"",house_address1:"",house_address2:"",message:"",product:"",selectedProduct:"",otherProduct:"",
        showSpinner:false
    }
  },
  methods: {
    ...
    submitform(){
      ...
      mounted(){
        ...
        then((data)=>{
            this.product=data["product"].filter(p => p.product_type === 'others')
